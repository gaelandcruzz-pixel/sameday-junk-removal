...
export const metadata: Metadata = {
  title: 'Junk Removal Oakville | Same-Day Service',
  description:
    'Fast junk removal in Oakville, ON. Furniture removal, appliance removal, garage cleanouts & estate cleanouts. Call 905-782-6332 for a free same-day quote.',
}
    ...
    <main className="min-h-screen bg-white px-6 py-20 text-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl">
          Sameday Junk Removal serves Oakville and surrounding areas. We remove furniture,
        ...
        <h2 className="text-3xl font-bold mb-6">Oakville Junk Removal Services</h2>
        <div className="grid md:grid-cols-2 gap-4 mb-14">
          {['Furniture Removal Oakville','Appliance Removal Oakville','Garage Cleanouts Oakville','Basement Cleanouts Oakville','Estate Cleanouts Oakville','Renovation Debris Removal','Carpet Removal Oakville','Storage Unit Cleanouts Oakville'].map((s) => (
        ...
        <div className="bg-black text-white rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-3">Need Junk Removed in Oakville?</h2>
          <p className="text-gray-300 mb-6">Call or text for same-day junk removal in Oakville.</p>
